...
def create_items
  Item.create!(name: 'mirror', initial_rooms: ['deep river'], score: 3)
  Item.create!(name: 'ladder', initial_rooms: ['old stone wall'], score: 3)
  Item.create!(name: 'cake', initial_rooms: ['trees'], score: 3)

  Item.create!(name: 'rope', initial_rooms: ['deep river'], score: 3)
  Item.create!(name: 'harp', initial_rooms: ['deep river'], score: 3)
  Item.create!(name: 'mask', initial_rooms: ['deep river'], score: 3)
  Item.create!(name: 'water', initial_rooms: ['deep river'], score: 3)
  Item.create!(name: 'penny', initial_rooms: ['deep river'], score: 3)
end
